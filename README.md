...
3. Откройте новую сессию в терминале и в зависимости от запускаемой базы данных и того какая строка "закомментирована" в файле [application.properties](https://github.com/Anasstaisha/QA49-DiplomProject/blob/main/application.properties) запустите SUT, убрав комментарий с нужной строки:
...
8. В первом терминале (в котором запускались контейнеры с БД) запустите команду "docker-compose down" для остановки контейнеров.